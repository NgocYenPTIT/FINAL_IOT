...
export default function DenseTable() {
    ...
    const sortt = (index) => {
        ...
        if (index === 5) {
            if (!sort5) dispatch(IsActiveActions.changeDataHistory([...state.dataHistory].sort((a, b) => a.Dust - b.Dust)));
            else dispatch(IsActiveActions.changeDataHistory([...state.dataHistory].sort((a, b) => b.Dust - a.Dust)));
            setSort5(!sort5);
        }
    }
            ...
            <Table sx={{ minWidth: 650, }} size="medium" aria-label="a dense table">
                <TableHead>
                    <TableRow sx={{
                        ...
                        <TableCell sx={{ color: 'inherit' }} align="center">Độ bụi {<FaSort onClick={() => sortt(5)} />}</TableCell>
                ...
                <TableBody>
                    {state?.dataHistory?.map((row) => (
                        ...
                        >
                            ...
                            <TableCell align="center" sx={{ padding: '4px' }}>{row.Dust}</TableCell>

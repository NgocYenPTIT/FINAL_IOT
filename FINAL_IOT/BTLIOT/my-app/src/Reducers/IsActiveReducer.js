...
const intialisActive = {
    ...
    dataChart: {
        ...
        dust: [1, 2, 12, 4, 5, 6, 15, 8, 9, 1, 11, 12],
    },
    loading1: false,
    loading2: false,
    loading3: false,
...
const changeNotii = (state, action) => {
    state.notii = action.payload;
}

const changeCntDust = (state, action) => {
    state.cntDust = action.payload;
}
...
const IsActiveReduce = createSlice({
    ...
    reducers: {
        ...
        changeAlert, changeCntDust, changeNotii
    }
})
